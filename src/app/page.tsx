  ...
  return (
    <div className={styles.pageParent}>
      <main className="p-4 text-white md:p-8 md:pt-16">
        ...
        <EasterEgg />
        <p className="max-w-[40rem] text-neutral-400">It's like a personality test but with really poorly written documentation. It's up to you to figure out what each number is for :)<br />Site works best on desktop.</p>
        <Calculator />
